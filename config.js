...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'Made By ALVIN' : process.env.ALL_CAPTION,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? '🅐🅛🅥🅘🅝🅢🅔🅡𝐁𝐎𝐓' : process.env.BOT_NAME,
    ...
    SUPPORT2: "918848059497-1632403322",
    SUPPORT3: "8848059497-1621015274"
};
